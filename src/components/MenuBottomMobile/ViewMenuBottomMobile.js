...
import './MenuBottomMobile.module.scss';
...
export default function TemporaryDrawer() {
    ...
    const renderUi = (vw = view) => {
        ...
        case VIEWS.FAVORITOS:
            return  <div>
                        <h2 onClick={() => setView(VIEWS.MENU_PRINCIPAL)} className="title">
                            <img src={iconBack} alt="Voltar" className="iconBack" />Favoritos </h2>
                            <Favorites setView={setView} />
                    </div>
        case VIEWS.FAQ:
            return <div>
                        <h2 onClick={() => setView(VIEWS.MENU_PRINCIPAL)} className="title"> 
                        <img src={iconBack} alt="Voltar" className="iconBack" />FAQ </h2>
                        <FAQ setView={setView} />
                    </div>
        case VIEWS.SOBRE:
    ...
    return (
        ...
        <Button onClick={toggleDrawer('bottom', true)}>
            <img src={iconTop} alt="Busca" className="iconMenu" /> Ver mais
        </Button>
